...
import { GET_NEW_WITH_LIMIT } from "../../../graphql/queries/filters/getNewWithLimit";

type Props = {};

const NewLimit = (props: Props) => {
  const { data, loading } = useQuery(GET_NEW_WITH_LIMIT);
  const lang = useLocale();
  const products = data?.getNewProductsWithLimit;
