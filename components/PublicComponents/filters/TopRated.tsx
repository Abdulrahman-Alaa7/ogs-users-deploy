...
import { GET_TOP_RATED } from "../../../graphql/queries/filters/getTopRated";

type Props = {};

const TopRated = (props: Props) => {
  const { data, loading: getProductsLoading } = useQuery(GET_TOP_RATED);

  const products = data?.getTopRated;
