...
import { GET_TOP_RATED_WITH_LIMIT } from "../../../graphql/queries/filters/getTopRatedWithLimit";

const TopRatedLimit = () => {
  const { data, loading } = useQuery(GET_TOP_RATED_WITH_LIMIT);
  const lang = useLocale();
  const products = data?.getTopRatedWithLimit;
